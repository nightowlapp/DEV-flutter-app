...
import 'package:nightowlcode/features/signup/widgets/second_create_nightowl_profile_screen.dart';
    ...
    return Stack(
      ...
      children: <Widget>[
        PageView(
          ...
          children: <Widget>[
            Center(child: FirstCreateNightowlProfileScreen()),
            Center(child: SecondCreateNightowlProfileScreen()),
            Center(child: ThirdCreateNightowlProfileScreen()),
          ],
        ),
        PageIndicator(
