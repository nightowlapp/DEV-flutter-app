...
FutureProvider.family<LocationIndicatorState, bool>((ref, enabledByUser) async {
...
Widget build(BuildContext context, WidgetRef ref) {
  ...
  return stateAsync.when(
    data: (s) {
      ...
      return Tooltip(
        message: isOn ? 'Location tracking is ON' : 'Location tracking is OFF',
        child: IconButton(
      ...
      child: Column(
        ...
        children: [
            ...
            Expanded(
              child: OwlButton(
                ...
                onPressed: () {
                  ...
                  OwlSnack.show(
                    context,
                    title: isOn ? 'Location sharing off' : 'Location sharing on',
          ...
          Text(
            ...
            style: Styles.basicText.copyWith(color: greyLighter, fontSize: 12),
