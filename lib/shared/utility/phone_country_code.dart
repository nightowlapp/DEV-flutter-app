...
class PhoneCountryCode {
  ...
  static final Map<CountryCode, String> _phoneCodes = {
    // Missing flags.
    // CountryCode.al: '+355',
    // CountryCode.ad: '+376',
    // CountryCode.am: '+374',
  ...
  static final Map<CountryCode, int> _minimumPhoneNumberLength = {
    CountryCode.al: 9,
    CountryCode.ad: 6,
    CountryCode.am: 8,
    CountryCode.at: 10,
  ...
  static final Map<CountryCode, Image> _flagImages = {
    for (var code in _phoneCodes.keys)
      code: Image.asset(
        'assets/flags/${code.name.toLowerCase()}.png', // 👈 your path
        width: 22,
        height: 16,
        fit: BoxFit.cover,
