...
enum VenueType { //database format
  unknown,
  club, bar, pub,
  beer_bar, cocktail_bar, gay_bar, wine_bar, sports_bar, karaoke_bar,
...
enum PartyStatusTypes{ out_tonight,house_party, pregame,recovering, still_planning,
