...
class Styles {
  ...
  static TextStyle get sloganTextGradient => baseFont.copyWith(
        //TODO
        fontSize: 20,
        letterSpacing: 3.5,
        fontWeight: FontWeight.w600,
  ...
  static Widget nameOrange() {
    final baseStyle = baseFont.copyWith(
        fontSize: 30, letterSpacing: -2.6, fontWeight: FontWeight.w200);
    return RichText(
        text: TextSpan(style: baseStyle, children: const [
      TextSpan(
          text: 'N',
          style: TextStyle(color: owlPurple, fontWeight: FontWeight.w500)),
      TextSpan(text: 'ight'),
      TextSpan(
          text: 'O',
          style: TextStyle(color: owlPurple, fontWeight: FontWeight.w500)),
  ...
  static Widget nameOrangeAttemptUpgrade() {
    ...
    TextStyle highlightStyle(Color color) {
      return baseStyle.copyWith(
          fontWeight: FontWeight.w600,
          foreground: Paint()
            ..shader = LinearGradient(colors: [color, white, color])
  ...
  static Widget nameWhite() {
    final baseStyle =
        baseFont.copyWith(fontSize: 30, fontWeight: FontWeight.w200);
    return RichText(
        text: TextSpan(style: baseStyle, children: const [
  ...
  static Widget logoCrazy(String text, {double fontSize = fontSizeSlogan}) {
    ...
    final TextStyle fill = GoogleFonts.pacifico(
      // cursive/script look
      fontSize: fontSize,
      ...
      foreground: Paint()
        ..shader = const LinearGradient(
          ...
          colors: <Color>[
            ...
            0, 0, fontSize * 10, fontSize * 2)), // wide gradient span
    );
