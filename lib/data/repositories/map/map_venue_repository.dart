...
class FirestoreMapVenueRepository implements AbstractVenueRepository {
  FirestoreMapVenueRepository({FirebaseFirestore? db})
      ...
      final sub = _db
          ...
          .listen((snap) {
            ...
            for (final doc in snap.docs) {
              ...
              final distM =
                  _haversine(vp.lat, vp.lng, gp.latitude, gp.longitude);
              ...
              final v = Venue(
                ...
                countryCode:
                    ((data['country_code'] ?? 'xx') as String).toLowerCase(),
                ...
                subscriptionType:
                    _safeSubType(data['subscription_type'] as String?),
  ...
  VenueType _safeVenueType(String? s) {
    ...
    return VenueType.values
        .firstWhere((e) => e.name == v, orElse: () => VenueType.unknown);
  }

  SubscriptionTypesVenue _safeSubType(String? s) {
    final v = (s ?? '').trim().toLowerCase();
    return SubscriptionTypesVenue.values.firstWhere((e) => e.name == v,
